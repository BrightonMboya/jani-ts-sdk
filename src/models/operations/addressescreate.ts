...
export type AddressesCreateRequestBody = {
   ...
   * Any valid JSON value
   */
  customData?: AddressesCreateCustomData | undefined;
  city?: string | null | undefined;
  status: AddressesCreateStatus;
 ...
 * Any valid JSON value
 */
export type AddressesCreateAddressesCustomData = {};

export const AddressesCreateAddressesStatus = {
  Active: "active",
  Archived: "archived",
} as const;
export type AddressesCreateAddressesStatus = ClosedEnum<
  typeof AddressesCreateAddressesStatus
>;
...
export type AddressesCreateResponseBody = {
   ...
   * Any valid JSON value
   */
  customData: AddressesCreateAddressesCustomData;
  city?: string | null | undefined;
  status: AddressesCreateAddressesStatus;
  createdAt: string;
  updatedAt: string;
  customerId?: string | null | undefined;
};
...
> = z.object({
  ...
  custom_data: z.lazy(() => AddressesCreateCustomData$inboundSchema).optional(),
  city: z.nullable(z.string()).optional(),
  status: AddressesCreateStatus$inboundSchema,
...
export type AddressesCreateRequestBody$Outbound = {
  ...
  custom_data?: AddressesCreateCustomData$Outbound | undefined;
  city?: string | null | undefined;
  status: string;
...
> = z.object({
  ...
  customData: z.lazy(() => AddressesCreateCustomData$outboundSchema).optional(),
  city: z.nullable(z.string()).optional(),
  status: AddressesCreateStatus$outboundSchema,
...
/** @internal */
export const AddressesCreateAddressesCustomData$inboundSchema: z.ZodType<
  AddressesCreateAddressesCustomData,
  z.ZodTypeDef,
  unknown
> = z.object({});

/** @internal */
export type AddressesCreateAddressesCustomData$Outbound = {};

/** @internal */
export const AddressesCreateAddressesCustomData$outboundSchema: z.ZodType<
  AddressesCreateAddressesCustomData$Outbound,
  z.ZodTypeDef,
  AddressesCreateAddressesCustomData
> = z.object({});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace AddressesCreateAddressesCustomData$ {
  /** @deprecated use `AddressesCreateAddressesCustomData$inboundSchema` instead. */
  export const inboundSchema = AddressesCreateAddressesCustomData$inboundSchema;
  /** @deprecated use `AddressesCreateAddressesCustomData$outboundSchema` instead. */
  export const outboundSchema =
    AddressesCreateAddressesCustomData$outboundSchema;
  /** @deprecated use `AddressesCreateAddressesCustomData$Outbound` instead. */
  export type Outbound = AddressesCreateAddressesCustomData$Outbound;
}

export function addressesCreateAddressesCustomDataToJSON(
  addressesCreateAddressesCustomData: AddressesCreateAddressesCustomData,
): string {
  return JSON.stringify(
    AddressesCreateAddressesCustomData$outboundSchema.parse(
      addressesCreateAddressesCustomData,
    ),
  );
}

export function addressesCreateAddressesCustomDataFromJSON(
  jsonString: string,
): SafeParseResult<AddressesCreateAddressesCustomData, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      AddressesCreateAddressesCustomData$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'AddressesCreateAddressesCustomData' from JSON`,
  );
}

/** @internal */
export const AddressesCreateAddressesStatus$inboundSchema: z.ZodNativeEnum<
  typeof AddressesCreateAddressesStatus
> = z.nativeEnum(AddressesCreateAddressesStatus);

/** @internal */
export const AddressesCreateAddressesStatus$outboundSchema: z.ZodNativeEnum<
  typeof AddressesCreateAddressesStatus
> = AddressesCreateAddressesStatus$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace AddressesCreateAddressesStatus$ {
  /** @deprecated use `AddressesCreateAddressesStatus$inboundSchema` instead. */
  export const inboundSchema = AddressesCreateAddressesStatus$inboundSchema;
  /** @deprecated use `AddressesCreateAddressesStatus$outboundSchema` instead. */
  export const outboundSchema = AddressesCreateAddressesStatus$outboundSchema;
}
...
> = z.object({
  ...
  description: z.nullable(z.string()).optional(),
  first_line: z.nullable(z.string()).optional(),
  custom_data: z.lazy(() => AddressesCreateAddressesCustomData$inboundSchema),
  city: z.nullable(z.string()).optional(),
  status: AddressesCreateAddressesStatus$inboundSchema,
  created_at: z.string(),
  updated_at: z.string(),
  customer_id: z.nullable(z.string()).optional(),
}).transform((v) => {
...
export type AddressesCreateResponseBody$Outbound = {
  ...
  description?: string | null | undefined;
  first_line?: string | null | undefined;
  custom_data: AddressesCreateAddressesCustomData$Outbound;
  city?: string | null | undefined;
  status: string;
  created_at: string;
  updated_at: string;
...
> = z.object({
  ...
  description: z.nullable(z.string()).optional(),
  firstLine: z.nullable(z.string()).optional(),
  customData: z.lazy(() => AddressesCreateAddressesCustomData$outboundSchema),
  city: z.nullable(z.string()).optional(),
  status: AddressesCreateAddressesStatus$outboundSchema,
  createdAt: z.string(),
  updatedAt: z.string(),
  customerId: z.nullable(z.string()).optional(),
}).transform((v) => {
