 ...
 * Any valid JSON value
 */
export type AddressesCreateCustomersAddressesCustomData = {};

export const AddressesCreateCustomersAddressesStatus = {
  Active: "active",
  Archived: "archived",
} as const;
export type AddressesCreateCustomersAddressesStatus = ClosedEnum<
  typeof AddressesCreateCustomersAddressesStatus
>;
...
export type AddressesCreateResponseBody = {
   ...
   * Any valid JSON value
   */
  customData: AddressesCreateCustomersAddressesCustomData;
  city?: string | null | undefined;
  status: AddressesCreateCustomersAddressesStatus;
  createdAt: string;
  updatedAt: string;
  customerId?: string | null | undefined;
};
...
/** @internal */
export const AddressesCreateCustomersAddressesCustomData$inboundSchema:
  z.ZodType<
    AddressesCreateCustomersAddressesCustomData,
    z.ZodTypeDef,
    unknown
  > = z.object({});

/** @internal */
export type AddressesCreateCustomersAddressesCustomData$Outbound = {};

/** @internal */
export const AddressesCreateCustomersAddressesCustomData$outboundSchema:
  z.ZodType<
    AddressesCreateCustomersAddressesCustomData$Outbound,
    z.ZodTypeDef,
    AddressesCreateCustomersAddressesCustomData
  > = z.object({});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace AddressesCreateCustomersAddressesCustomData$ {
  /** @deprecated use `AddressesCreateCustomersAddressesCustomData$inboundSchema` instead. */
  export const inboundSchema =
    AddressesCreateCustomersAddressesCustomData$inboundSchema;
  /** @deprecated use `AddressesCreateCustomersAddressesCustomData$outboundSchema` instead. */
  export const outboundSchema =
    AddressesCreateCustomersAddressesCustomData$outboundSchema;
  /** @deprecated use `AddressesCreateCustomersAddressesCustomData$Outbound` instead. */
  export type Outbound = AddressesCreateCustomersAddressesCustomData$Outbound;
}

export function addressesCreateCustomersAddressesCustomDataToJSON(
  addressesCreateCustomersAddressesCustomData:
    AddressesCreateCustomersAddressesCustomData,
): string {
  return JSON.stringify(
    AddressesCreateCustomersAddressesCustomData$outboundSchema.parse(
      addressesCreateCustomersAddressesCustomData,
    ),
  );
}

export function addressesCreateCustomersAddressesCustomDataFromJSON(
  jsonString: string,
): SafeParseResult<
  AddressesCreateCustomersAddressesCustomData,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      AddressesCreateCustomersAddressesCustomData$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'AddressesCreateCustomersAddressesCustomData' from JSON`,
  );
}

/** @internal */
export const AddressesCreateCustomersAddressesStatus$inboundSchema:
  z.ZodNativeEnum<typeof AddressesCreateCustomersAddressesStatus> = z
    .nativeEnum(AddressesCreateCustomersAddressesStatus);

/** @internal */
export const AddressesCreateCustomersAddressesStatus$outboundSchema:
  z.ZodNativeEnum<typeof AddressesCreateCustomersAddressesStatus> =
    AddressesCreateCustomersAddressesStatus$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace AddressesCreateCustomersAddressesStatus$ {
  /** @deprecated use `AddressesCreateCustomersAddressesStatus$inboundSchema` instead. */
  export const inboundSchema =
    AddressesCreateCustomersAddressesStatus$inboundSchema;
  /** @deprecated use `AddressesCreateCustomersAddressesStatus$outboundSchema` instead. */
  export const outboundSchema =
    AddressesCreateCustomersAddressesStatus$outboundSchema;
}
...
> = z.object({
  ...
  city: z.nullable(z.string()).optional(),
  status: AddressesCreateCustomersAddressesStatus$inboundSchema,
  created_at: z.string(),
  updated_at: z.string(),
  customer_id: z.nullable(z.string()).optional(),
}).transform((v) => {
...
export type AddressesCreateResponseBody$Outbound = {
  ...
  description?: string | null | undefined;
  first_line?: string | null | undefined;
  custom_data: AddressesCreateCustomersAddressesCustomData$Outbound;
  city?: string | null | undefined;
  status: string;
  created_at: string;
  updated_at: string;
...
> = z.object({
  ...
  city: z.nullable(z.string()).optional(),
  status: AddressesCreateCustomersAddressesStatus$outboundSchema,
  createdAt: z.string(),
  updatedAt: z.string(),
  customerId: z.nullable(z.string()).optional(),
}).transform((v) => {
