 ...
 * Any valid JSON value
 */
export type AddressesUpdateCustomersAddressesCustomData = {};

export const AddressesUpdateCustomersAddressesStatus = {
  Active: "active",
  Archived: "archived",
} as const;
export type AddressesUpdateCustomersAddressesStatus = ClosedEnum<
  typeof AddressesUpdateCustomersAddressesStatus
>;
...
export type AddressesUpdateResponseBody = {
   ...
   * Any valid JSON value
   */
  customData: AddressesUpdateCustomersAddressesCustomData;
  city?: string | null | undefined;
  status: AddressesUpdateCustomersAddressesStatus;
  createdAt: string;
  updatedAt: string;
  customerId?: string | null | undefined;
};
...
/** @internal */
export const AddressesUpdateCustomersAddressesCustomData$inboundSchema:
  z.ZodType<
    AddressesUpdateCustomersAddressesCustomData,
    z.ZodTypeDef,
    unknown
  > = z.object({});

/** @internal */
export type AddressesUpdateCustomersAddressesCustomData$Outbound = {};

/** @internal */
export const AddressesUpdateCustomersAddressesCustomData$outboundSchema:
  z.ZodType<
    AddressesUpdateCustomersAddressesCustomData$Outbound,
    z.ZodTypeDef,
    AddressesUpdateCustomersAddressesCustomData
  > = z.object({});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace AddressesUpdateCustomersAddressesCustomData$ {
  /** @deprecated use `AddressesUpdateCustomersAddressesCustomData$inboundSchema` instead. */
  export const inboundSchema =
    AddressesUpdateCustomersAddressesCustomData$inboundSchema;
  /** @deprecated use `AddressesUpdateCustomersAddressesCustomData$outboundSchema` instead. */
  export const outboundSchema =
    AddressesUpdateCustomersAddressesCustomData$outboundSchema;
  /** @deprecated use `AddressesUpdateCustomersAddressesCustomData$Outbound` instead. */
  export type Outbound = AddressesUpdateCustomersAddressesCustomData$Outbound;
}

export function addressesUpdateCustomersAddressesCustomDataToJSON(
  addressesUpdateCustomersAddressesCustomData:
    AddressesUpdateCustomersAddressesCustomData,
): string {
  return JSON.stringify(
    AddressesUpdateCustomersAddressesCustomData$outboundSchema.parse(
      addressesUpdateCustomersAddressesCustomData,
    ),
  );
}

export function addressesUpdateCustomersAddressesCustomDataFromJSON(
  jsonString: string,
): SafeParseResult<
  AddressesUpdateCustomersAddressesCustomData,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      AddressesUpdateCustomersAddressesCustomData$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'AddressesUpdateCustomersAddressesCustomData' from JSON`,
  );
}

/** @internal */
export const AddressesUpdateCustomersAddressesStatus$inboundSchema:
  z.ZodNativeEnum<typeof AddressesUpdateCustomersAddressesStatus> = z
    .nativeEnum(AddressesUpdateCustomersAddressesStatus);

/** @internal */
export const AddressesUpdateCustomersAddressesStatus$outboundSchema:
  z.ZodNativeEnum<typeof AddressesUpdateCustomersAddressesStatus> =
    AddressesUpdateCustomersAddressesStatus$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace AddressesUpdateCustomersAddressesStatus$ {
  /** @deprecated use `AddressesUpdateCustomersAddressesStatus$inboundSchema` instead. */
  export const inboundSchema =
    AddressesUpdateCustomersAddressesStatus$inboundSchema;
  /** @deprecated use `AddressesUpdateCustomersAddressesStatus$outboundSchema` instead. */
  export const outboundSchema =
    AddressesUpdateCustomersAddressesStatus$outboundSchema;
}
...
> = z.object({
  ...
  city: z.nullable(z.string()).optional(),
  status: AddressesUpdateCustomersAddressesStatus$inboundSchema,
  created_at: z.string(),
  updated_at: z.string(),
  customer_id: z.nullable(z.string()).optional(),
}).transform((v) => {
...
export type AddressesUpdateResponseBody$Outbound = {
  ...
  description?: string | null | undefined;
  first_line?: string | null | undefined;
  custom_data: AddressesUpdateCustomersAddressesCustomData$Outbound;
  city?: string | null | undefined;
  status: string;
  created_at: string;
  updated_at: string;
...
> = z.object({
  ...
  city: z.nullable(z.string()).optional(),
  status: AddressesUpdateCustomersAddressesStatus$outboundSchema,
  createdAt: z.string(),
  updatedAt: z.string(),
  customerId: z.nullable(z.string()).optional(),
}).transform((v) => {
