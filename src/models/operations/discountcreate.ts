 ...
 * Any valid JSON value
 */
export type DiscountCreateDiscountsCustomData = {};
...
export type DiscountCreateResponseBody = {
  id: string;
  status: DiscountCreateDiscountsStatus;
  description?: string | null | undefined;
  enabledForCheckout?: boolean | null | undefined;
  amount: number;
  currencyCode: string;
   ...
   * Any valid JSON value
   */
  customData: DiscountCreateDiscountsCustomData;
...
export const DiscountCreateRequestBody$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  status: DiscountCreateStatus$inboundSchema,
...
export const DiscountCreateRequestBody$outboundSchema: z.ZodType<
  ...
  DiscountCreateRequestBody
> = z.object({
  status: DiscountCreateStatus$outboundSchema,
  description: z.nullable(z.string()).optional(),
...
/** @internal */
export const DiscountCreateDiscountsCustomData$inboundSchema: z.ZodType<
  DiscountCreateDiscountsCustomData,
  z.ZodTypeDef,
  unknown
> = z.object({});

/** @internal */
export type DiscountCreateDiscountsCustomData$Outbound = {};

/** @internal */
export const DiscountCreateDiscountsCustomData$outboundSchema: z.ZodType<
  DiscountCreateDiscountsCustomData$Outbound,
  z.ZodTypeDef,
  DiscountCreateDiscountsCustomData
> = z.object({});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace DiscountCreateDiscountsCustomData$ {
  /** @deprecated use `DiscountCreateDiscountsCustomData$inboundSchema` instead. */
  export const inboundSchema = DiscountCreateDiscountsCustomData$inboundSchema;
  /** @deprecated use `DiscountCreateDiscountsCustomData$outboundSchema` instead. */
  export const outboundSchema =
    DiscountCreateDiscountsCustomData$outboundSchema;
  /** @deprecated use `DiscountCreateDiscountsCustomData$Outbound` instead. */
  export type Outbound = DiscountCreateDiscountsCustomData$Outbound;
}

export function discountCreateDiscountsCustomDataToJSON(
  discountCreateDiscountsCustomData: DiscountCreateDiscountsCustomData,
): string {
  return JSON.stringify(
    DiscountCreateDiscountsCustomData$outboundSchema.parse(
      discountCreateDiscountsCustomData,
    ),
  );
}

export function discountCreateDiscountsCustomDataFromJSON(
  jsonString: string,
): SafeParseResult<DiscountCreateDiscountsCustomData, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DiscountCreateDiscountsCustomData$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DiscountCreateDiscountsCustomData' from JSON`,
  );
}
...
> = z.object({
  id: z.string(),
  status: DiscountCreateDiscountsStatus$inboundSchema,
  description: z.nullable(z.string()).optional(),
  enabled_for_checkout: z.nullable(z.boolean()).optional(),
  amount: z.number(),
  currency_code: z.string(),
  ...
  usage_limit: z.nullable(z.number().int()).optional(),
  expires_at: z.nullable(z.string()).optional(),
  custom_data: z.lazy(() => DiscountCreateDiscountsCustomData$inboundSchema),
...
export type DiscountCreateResponseBody$Outbound = {
  ...
  usage_limit?: number | null | undefined;
  expires_at?: string | null | undefined;
  custom_data: DiscountCreateDiscountsCustomData$Outbound;
...
> = z.object({
  id: z.string(),
  status: DiscountCreateDiscountsStatus$outboundSchema,
  description: z.nullable(z.string()).optional(),
  enabledForCheckout: z.nullable(z.boolean()).optional(),
  amount: z.number(),
  currencyCode: z.string(),
  ...
  usageLimit: z.nullable(z.number().int()).optional(),
  expiresAt: z.nullable(z.string()).optional(),
  customData: z.lazy(() => DiscountCreateDiscountsCustomData$outboundSchema),
