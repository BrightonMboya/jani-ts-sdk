 ...
 */
export type DiscountListCustomData = {};
...
export type DiscountListResponseBody = {
   ...
   * Any valid JSON value
   */
  customData: DiscountListCustomData;
...
/** @internal */
export const DiscountListCustomData$inboundSchema: z.ZodType<
  DiscountListCustomData,
  z.ZodTypeDef,
  unknown
> = z.object({});

/** @internal */
export type DiscountListCustomData$Outbound = {};

/** @internal */
export const DiscountListCustomData$outboundSchema: z.ZodType<
  DiscountListCustomData$Outbound,
  z.ZodTypeDef,
  DiscountListCustomData
> = z.object({});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace DiscountListCustomData$ {
  /** @deprecated use `DiscountListCustomData$inboundSchema` instead. */
  export const inboundSchema = DiscountListCustomData$inboundSchema;
  /** @deprecated use `DiscountListCustomData$outboundSchema` instead. */
  export const outboundSchema = DiscountListCustomData$outboundSchema;
  /** @deprecated use `DiscountListCustomData$Outbound` instead. */
  export type Outbound = DiscountListCustomData$Outbound;
}

export function discountListCustomDataToJSON(
  discountListCustomData: DiscountListCustomData,
): string {
  return JSON.stringify(
    DiscountListCustomData$outboundSchema.parse(discountListCustomData),
  );
}

export function discountListCustomDataFromJSON(
  jsonString: string,
): SafeParseResult<DiscountListCustomData, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DiscountListCustomData$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DiscountListCustomData' from JSON`,
  );
}
...
> = z.object({
  ...
  custom_data: z.lazy(() => DiscountListCustomData$inboundSchema),
...
export type DiscountListResponseBody$Outbound = {
  ...
  custom_data: DiscountListCustomData$Outbound;
...
> = z.object({
  ...
  customData: z.lazy(() => DiscountListCustomData$outboundSchema),
