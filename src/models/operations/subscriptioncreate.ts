 ...
 */
export type SubscriptionCreateSubscriptionsResponseCustomData = {};
...
export type SubscriptionCreatePrice = {
   ...
   * Any valid JSON value
   */
  customData?: SubscriptionCreateSubscriptionsResponseCustomData | undefined;
  id: string;
  createdAt: string;
  updatedAt: string;
};
...
export type SubscriptionCreateDiscount = {
  id: string;
  status: SubscriptionCreateSubscriptionsResponse200Status;
  description?: string | null | undefined;
   ...
   * Any valid JSON value
   */
  customData: SubscriptionCreateSubscriptionsCustomData;
...
/** @internal */
export const SubscriptionCreateSubscriptionsResponseCustomData$inboundSchema:
  z.ZodType<
    SubscriptionCreateSubscriptionsResponseCustomData,
    z.ZodTypeDef,
    unknown
  > = z.object({});

/** @internal */
export type SubscriptionCreateSubscriptionsResponseCustomData$Outbound = {};

/** @internal */
export const SubscriptionCreateSubscriptionsResponseCustomData$outboundSchema:
  z.ZodType<
    SubscriptionCreateSubscriptionsResponseCustomData$Outbound,
    z.ZodTypeDef,
    SubscriptionCreateSubscriptionsResponseCustomData
  > = z.object({});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace SubscriptionCreateSubscriptionsResponseCustomData$ {
  /** @deprecated use `SubscriptionCreateSubscriptionsResponseCustomData$inboundSchema` instead. */
  export const inboundSchema =
    SubscriptionCreateSubscriptionsResponseCustomData$inboundSchema;
  /** @deprecated use `SubscriptionCreateSubscriptionsResponseCustomData$outboundSchema` instead. */
  export const outboundSchema =
    SubscriptionCreateSubscriptionsResponseCustomData$outboundSchema;
  /** @deprecated use `SubscriptionCreateSubscriptionsResponseCustomData$Outbound` instead. */
  export type Outbound =
    SubscriptionCreateSubscriptionsResponseCustomData$Outbound;
}

export function subscriptionCreateSubscriptionsResponseCustomDataToJSON(
  subscriptionCreateSubscriptionsResponseCustomData:
    SubscriptionCreateSubscriptionsResponseCustomData,
): string {
  return JSON.stringify(
    SubscriptionCreateSubscriptionsResponseCustomData$outboundSchema.parse(
      subscriptionCreateSubscriptionsResponseCustomData,
    ),
  );
}

export function subscriptionCreateSubscriptionsResponseCustomDataFromJSON(
  jsonString: string,
): SafeParseResult<
  SubscriptionCreateSubscriptionsResponseCustomData,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      SubscriptionCreateSubscriptionsResponseCustomData$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'SubscriptionCreateSubscriptionsResponseCustomData' from JSON`,
  );
}
...
> = z.object({
  ...
  price: z.lazy(() => SubscriptionCreatePrice$inboundSchema),
}).transform((v) => {
  return remap$(v, {
    "price_id": "priceId",
    "subscription_id": "subscriptionId",
...
export type SubscriptionCreateItems$Outbound = {
  ...
  price: SubscriptionCreatePrice$Outbound;
};
...
> = z.object({
  ...
  price: z.lazy(() => SubscriptionCreatePrice$outboundSchema),
}).transform((v) => {
  return remap$(v, {
    priceId: "price_id",
    subscriptionId: "subscription_id",
...
export type SubscriptionCreateDiscount$Outbound = {
  ...
  custom_data: SubscriptionCreateSubscriptionsCustomData$Outbound;
