 ...
 */
export type SubscriptionListSubscriptionsResponseCustomData = {};
...
export type SubscriptionListPrice = {
   ...
   * Any valid JSON value
   */
  customData?: SubscriptionListSubscriptionsResponseCustomData | undefined;
  id: string;
  createdAt: string;
  updatedAt: string;
};
...
export type SubscriptionListDiscount = {
  id: string;
  status: SubscriptionListSubscriptionsResponseStatus;
  description?: string | null | undefined;
   ...
   * Any valid JSON value
   */
  customData: SubscriptionListSubscriptionsCustomData;
...
/** @internal */
export const SubscriptionListSubscriptionsResponseCustomData$inboundSchema:
  z.ZodType<
    SubscriptionListSubscriptionsResponseCustomData,
    z.ZodTypeDef,
    unknown
  > = z.object({});

/** @internal */
export type SubscriptionListSubscriptionsResponseCustomData$Outbound = {};

/** @internal */
export const SubscriptionListSubscriptionsResponseCustomData$outboundSchema:
  z.ZodType<
    SubscriptionListSubscriptionsResponseCustomData$Outbound,
    z.ZodTypeDef,
    SubscriptionListSubscriptionsResponseCustomData
  > = z.object({});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace SubscriptionListSubscriptionsResponseCustomData$ {
  /** @deprecated use `SubscriptionListSubscriptionsResponseCustomData$inboundSchema` instead. */
  export const inboundSchema =
    SubscriptionListSubscriptionsResponseCustomData$inboundSchema;
  /** @deprecated use `SubscriptionListSubscriptionsResponseCustomData$outboundSchema` instead. */
  export const outboundSchema =
    SubscriptionListSubscriptionsResponseCustomData$outboundSchema;
  /** @deprecated use `SubscriptionListSubscriptionsResponseCustomData$Outbound` instead. */
  export type Outbound =
    SubscriptionListSubscriptionsResponseCustomData$Outbound;
}

export function subscriptionListSubscriptionsResponseCustomDataToJSON(
  subscriptionListSubscriptionsResponseCustomData:
    SubscriptionListSubscriptionsResponseCustomData,
): string {
  return JSON.stringify(
    SubscriptionListSubscriptionsResponseCustomData$outboundSchema.parse(
      subscriptionListSubscriptionsResponseCustomData,
    ),
  );
}

export function subscriptionListSubscriptionsResponseCustomDataFromJSON(
  jsonString: string,
): SafeParseResult<
  SubscriptionListSubscriptionsResponseCustomData,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      SubscriptionListSubscriptionsResponseCustomData$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'SubscriptionListSubscriptionsResponseCustomData' from JSON`,
  );
}
...
> = z.object({
  id: z.string(),
  status: SubscriptionListSubscriptionsResponseStatus$inboundSchema,
  description: z.nullable(z.string()).optional(),
...
export type SubscriptionListDiscount$Outbound = {
  ...
  custom_data: SubscriptionListSubscriptionsCustomData$Outbound;
...
> = z.object({
  id: z.string(),
  status: SubscriptionListSubscriptionsResponseStatus$outboundSchema,
  description: z.nullable(z.string()).optional(),
