 ...
 */
export type SubscriptionPauseSubscriptionSubscriptionsResponseCustomData = {};
...
export type SubscriptionPauseSubscriptionPrice = {
   ...
   */
  customData?:
    | SubscriptionPauseSubscriptionSubscriptionsResponseCustomData
    | undefined;
  id: string;
  createdAt: string;
  updatedAt: string;
...
export type SubscriptionPauseSubscriptionDiscount = {
  id: string;
  status: SubscriptionPauseSubscriptionSubscriptionsResponseStatus;
  description?: string | null | undefined;
   ...
   * Any valid JSON value
   */
  customData: SubscriptionPauseSubscriptionSubscriptionsCustomData;
...
/** @internal */
export const SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$inboundSchema:
  z.ZodType<
    SubscriptionPauseSubscriptionSubscriptionsResponseCustomData,
    z.ZodTypeDef,
    unknown
...
/** @internal */
export type SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$Outbound =
  {};

/** @internal */
export const SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$outboundSchema:
  z.ZodType<
    SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$Outbound,
    z.ZodTypeDef,
    SubscriptionPauseSubscriptionSubscriptionsResponseCustomData
  > = z.object({});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$ {
  /** @deprecated use `SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$inboundSchema` instead. */
  export const inboundSchema =
    SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$inboundSchema;
  /** @deprecated use `SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$outboundSchema` instead. */
  export const outboundSchema =
    SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$outboundSchema;
  /** @deprecated use `SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$Outbound` instead. */
  export type Outbound =
    SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$Outbound;
}

export function subscriptionPauseSubscriptionSubscriptionsResponseCustomDataToJSON(
  subscriptionPauseSubscriptionSubscriptionsResponseCustomData:
    SubscriptionPauseSubscriptionSubscriptionsResponseCustomData,
): string {
  return JSON.stringify(
    SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$outboundSchema
      .parse(subscriptionPauseSubscriptionSubscriptionsResponseCustomData),
  );
}

export function subscriptionPauseSubscriptionSubscriptionsResponseCustomDataFromJSON(
  jsonString: string,
): SafeParseResult<
  SubscriptionPauseSubscriptionSubscriptionsResponseCustomData,
  SDKValidationError
> {
  return safeParse(
    ...
    (x) =>
      SubscriptionPauseSubscriptionSubscriptionsResponseCustomData$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'SubscriptionPauseSubscriptionSubscriptionsResponseCustomData' from JSON`,
  );
}
...
export type SubscriptionPauseSubscriptionDiscount$Outbound = {
  ...
  custom_data: SubscriptionPauseSubscriptionSubscriptionsCustomData$Outbound;
